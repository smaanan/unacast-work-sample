...
citibank$birth.year = as.integer(citibank$birth.year)

citibank$usertype = as.factor(citibank$usertype)

citibank$gender = as.factor(citibank$gender)

levels(citibank$gender) = c("UNKNOWN", "MALE", "FEMALE")
...
ggplot(citibank) + geom_histogram(aes(birth.year), color = "darkorange",  fill="cornsilk", alpha=0.4) +
  ...
  labs(title = "Birth Year of NYC Citibike Users", subtitle = "Data from 01/01/2017 to 31/12/2018") +
...
ggplot(citibank) + 
  ...
  labs(title = "Share of Subscribers and Customers among NYC Citibike Users", subtitle = "Data from 01/01/2017 to 31/12/2018") +
...
ggplot(citibank) + 
  ...
  labs(title = "Gender Distribution of NYC Citibike Users", subtitle = "Data from 01/01/2017 to 31/12/2018") +
...
citibank %>% 
  ...
  labs(title = "Age Distribution of Male and Female Citibike Users", subtitle = "Data from 01/01/2017 to 31/12/2018") +
...
ggplot(citibank) + geom_histogram(aes(tripduration.min), color = "darkorange",  fill="cornsilk", alpha=0.4) +
  labs(title = "Dsitribution of Trip Duration of NYC Citibike Users", subtitle = "Data from 01/01/2017 to 31/12/2018") +
...
ggplot(citibank) +
  ...
  labs(title = "Percentage of Trips in Each Day of the Week", subtitle = "Data from 01/01/2017 to 31/12/2018") +
  xlab("Weekday") + ylab("") +
  theme_bw()
...
ggplot(citibank) + 
  ...
  labs(title = "Percentage of Daily Trips by User Type", subtitle = "Data from 01/01/2017 to 31/12/2018", fill = "User Type") +
...
ggplot(citibank) +
  ...
  labs(title = "Percentage of Trips in Each Hour of the Day", subtitle = "Data from 01/01/2017 to 31/12/2018") +
  xlab("Hour") + ylab("") +
  theme_bw()
...
ggplot(citibank) + 
  ...
  labs(title = "Percentage of Hourly Trips by User Type", subtitle = "Data from 01/01/2017 to 31/12/2018", fill = "User Type") +
  scale_fill_manual(values = c("darkorange3","cornsilk")) +
  xlab("Hour") + ylab("") +
  theme_bw()
